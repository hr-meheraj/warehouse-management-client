    ...
    return (
        <div className=''>
                        ...
                        return (
                            <div key={_id} className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div className="p-5">
                                    ...
                                    <p className="text-pink-600 font-xl font-semibold mb-3">     Quantity : {quantity}
                                    </p>
            ...
            <div className='mb-[70px] mt-[25px] container mx-auto max-w-[720px] w-[95%]'>
                {
                    count && [...Array(count).keys()].map((each, index) => {
                        return (
                            <button onClick={() => setPage(each)} key={index} className={`shadow-lg py-2 px-4  transition-all hover:bg-blue-900 ${each === page ? "bg-blue-800 text-white " : ""}`}>{each + 1} </button>
                        )
                    })
                }
