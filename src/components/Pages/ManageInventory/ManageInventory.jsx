          ...
          Do you want to Add new Item?{" "}
            ...
            <div className="container w-[95%] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[15px]">
                {products.map((eachProducts) => {
                    const { _id, price, title, description, url, quantity, sellerName } =
                        eachProducts;
                    return (
                        <div
                            key={_id}
                            className="max-w-sm card bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700"
                        >
                  ...
                  <svg
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center py-2  px-3 text-sm font-medium text-center ml-3 text-white bg-red-700 rounded-lg hover:bg-blue-900 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                >
                                    Delete
                </button>
                            </div>
                    ...
                    [...Array(count).keys()].map((each, index) => {
                        return (
                            <button
                                ...
                                key={index}
                                className={`shadow-lg py-2 px-4  transition-all hover:bg-blue-900 ${each === page ? "bg-blue-800 text-white " : ""
                                    }`}
                            >
                                {each + 1}{" "}
                            </button>
