...
function Inventories() {
    ...
    return (
        <div>
            <h2 className='text-center text-blue-800 text-3xl mt-[35px] mb-[20px]' >Inventory Items </h2>
                    ...
                    arr.map(each => {
                        return(
                            <div class="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <img class="rounded-t-lg" src="https://flowbite.com/docs/images/blog/image-1.jpg" alt="Inventory" />
