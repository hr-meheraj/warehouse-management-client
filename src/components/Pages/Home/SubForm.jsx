...
const SubForm = () => {
    ...
    return(
        <div className='w-full py-[40px] my-[40px] sub-form'>
            <form className='max-w-[720px] text-white  mx-auto w-[95%]' onSubmit={handleSubmit}>
                ...
                <input type='submit' value='Request' className='my-3 btn bg-blue-700 hover:bg-blue-900 transition-all'/>
            </form>
        </div>
    )
}
