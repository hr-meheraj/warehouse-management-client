    ...
    return (
        <div className='h-screen w-full flex justify-center mt-[30px]'>
             <form onSubmit={handleRegisterSubmit} className='p-4 mx-auto w-[95%] max-w-[720px] shadow-lg rounded-md  container'>
                 <h2 className='text-center text-xl sm:text-2xl text-blue-800 py-4 font-semibold   '>CREATE NEW ACCOUNT </h2>
                 <div className=''>
                     <label htmlFor='email' className=' block  py-[5px] w-full'>Email:</label>
                     <input type='email' autoComplete='false' onChange={handleEmailChange} id='email' required placeholder='enter your email 'className='py-2 px-4 my-[15px] border block w-full  rounded-md shadow-md' />
                     
                 </div>        {
                     userInfoErr?.emailErr && <p className='text-red-800  pt-2'>{userInfoErr.emailErr}</p>
                 }
                 <br/>
                 <div className=''>
                     <label htmlFor='password' className='w-full block  py-[5px]'>Password:</label>
                     <input type='password' autoComplete="false" onChange={handlePasswordChange} id='password' required placeholder='Enter your password' className=' py-2 px-4 my-[15px]  block w-full border rounded-md shadow-md ' />
                 </div>
                 {
                   userInfoErr?.passwordErr && <p className='text-red-800  pt-2'>{userInfoErr.passwordErr}</p>
                 }
                 <br/>
                  <div className=''>
                     <label htmlFor='confirmPasword' className='w-full block  py-[5px]'>Confirm Password:</label>
                     <input type='password' autoComplete="false" onChange={handleConfirmPassword} id='confirmPassword' required placeholder='Re-type your password' className=' py-2 px-4  block w-full border rounded-md shadow-md ' />
                 </div>
                 <br/>
