...
function Login() {
    ...
    if (googleUser) {
        ...
        const url = 'https://mern-stack-inventory-management.hrmeheraj.repl.co/login';
        fetch(url, {
         method : 'POST',
         headers : {
    ...
    const handleLoginWithEmail =async (e) => {
        ...
        const { data } = await axios.post('https://mern-stack-inventory-management.hrmeheraj.repl.co/login', {email});
        localStorage.setItem("accessToken", data.accessToken);
        console.log(data);
        navigate(from, { replace: true });
