...
function Footer() {
    ...
    return (
        <div className="mt-[120px] bg-[#1f2937]">
            <div className="container mx-auto  pt-[50px] gap-[30px] w-[95%] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="flex w-[70%] mx-auto justify-center gap-[15px]">
                    <a
                        href="https://linkedin.com/hrmeheraj"
                        target="_blank"
                        rel="noreferrer"
                    >
                        <svg
            ...
            <div className="py-2 text-center mt-[40px] bg-[#1f2937]  text-gray-200">
